...
<body class="bg-white min-h-screen">
                            ...
                            <div class="relative group cursor-pointer pt-2 pb-2">
                                ...
                                <div class="absolute right-0 top-full mt-1 w-56 bg-white rounded-xl shadow-xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border border-gray-100">
                                    ...
                                    <div class="py-1 border-b border-gray-100">
                                        ...
                                        <a href="{{ route('dashboard') }}" class="flex items-center gap-2 px-4 py-2 text-sm font-bold text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition border-t border-gray-100">
    ...
    <div id="mobileSidebar"
        ...
        {{ request()->routeIs('dashboard') ? 'bg-white/20' : 'hover:bg-white/20' }}">
                    Dashboard Admin
                </a>
                @endif
                @endauth
